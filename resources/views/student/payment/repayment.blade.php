<x-master>
  ...
  <div class="row mb-4" >
    ...
    <table class="table text-center border-bottom-warning table-info table-striped" >
      ...
      <tr>
        <td><img src="{{$payment->course->image}}" class="rounded-2" alt="" height="60px" width="60px"></td>
  ...
  <div class="row">
    ...
    <div class="col items-center">
      ...
      <form method="post" action="{{route('payment.update',$payment)}}" class="mx-auto w-50" enctype="multipart/form-data">
        ...
        <div class="mt-2">
          ...
          <input type="text"  class="form-control" value="{{$payment->course->price}}" disabled>
          @error('name')
          <strong class="invalid-feedback">{{$message}}</strong>
          @enderror
        </div>
